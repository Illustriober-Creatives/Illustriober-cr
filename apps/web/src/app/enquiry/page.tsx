...
export default function EnquiryPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F4EFE5] pb-16 pt-32 text-[#171717] md:pt-40">
      ...
      <section className="mx-auto mt-14 max-w-6xl px-5 md:mt-16 md:px-8"><div className="grid overflow-hidden rounded-[2rem] border border-[#171717]/10 bg-[#FFFDF8] lg:grid-cols-[0.82fr_1.18fr]">
        <aside className="relative min-h-[300px] overflow-hidden bg-[#1F4D3D] p-7 text-[#F4EFE5] md:p-8 lg:min-h-full"><Image alt="Product workspace concept" className="object-cover opacity-35" fill sizes="(max-width: 1024px) 100vw, 40vw" src="/projects/concept-portal-dashboard.png" /><div className="relative flex h-full flex-col justify-between"><p className="max-w-sm font-display text-4xl leading-none">Good work starts with a clear conversation.</p><div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#f7ad45]">Prefer email?</p><a className="mt-2 inline-block text-lg font-bold hover:underline" href="mailto:hello@illustriober.com">hello@illustriober.com</a></div></div></aside>
        <div className="p-7 md:p-8"><h2 className="font-display text-4xl leading-none">Project enquiry</h2><p className="mt-3 text-sm leading-6 text-[#5F5A50]">Fields marked with * are needed to send your enquiry.</p>
