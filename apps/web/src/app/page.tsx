    ...
    <div className="overflow-hidden bg-[#F4EFE5] text-[#171717]">
      <section className="mx-auto max-w-7xl px-5 pb-16 pt-12 md:px-8 md:pb-24 md:pt-20">
        ...
        <div className="grid items-end gap-12 lg:grid-cols-[1fr_0.68fr]">
          <div>
            <h1 className="max-w-4xl font-display text-5xl leading-[0.9] tracking-[-0.05em] md:text-7xl lg:text-[6.6rem]">Websites, platforms, and apps that make work <em className="font-normal text-[#F39314]">easier.</em></h1>
