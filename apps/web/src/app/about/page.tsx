  ...
  return (
    <main className="min-h-screen bg-[#F4EFE5] pb-20 pt-36 text-[#171717] md:pt-48">
      ...
      <section className="mx-auto mt-14 max-w-7xl px-5 md:mt-20 md:px-8">
        ...
        <div className="grid overflow-hidden rounded-[2rem] bg-[#1F4D3D] transition-[transform,box-shadow] duration-[850ms] ease-[cubic-bezier(0.22,1,0.36,1)] motion-safe:hover:-translate-y-1 motion-safe:hover:shadow-[0_28px_70px_rgba(31,77,61,0.18)] motion-reduce:transition-none lg:grid-cols-2">
