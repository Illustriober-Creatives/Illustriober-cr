      ...
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-10 md:flex-row md:items-end">
        <div>
          <div className="flex items-center gap-2.5">
            <span className="grid h-9 w-9 place-items-center rounded-full bg-[#F39314] font-display text-lg font-bold text-[#171717]">
              il
            </span>
        ...
        <div className="flex flex-wrap gap-x-7 gap-y-3 text-sm font-semibold text-[#F4EFE5]/75">
          <Link className="hover:text-[#F7AD45]" href="/work">Work</Link>
          <Link className="hover:text-[#F7AD45]" href="/services">Services</Link>
          <Link className="hover:text-[#F7AD45]" href="/about">About</Link>
